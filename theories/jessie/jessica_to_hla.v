...
From jessie Require Import jessie_notation jessica_ast.
...
Module JessicaToHla.
  ...
  Proof.
    - destruct e as [x|_|n|bn|s|xs|op lhs rhs|lhs rhs|obj field|callee args|lhs rhs|op arg|fields|params body|params body|_].
      + exact (Some (Var x)).
      + exact None.
